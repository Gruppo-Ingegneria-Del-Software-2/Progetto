<div class="jumbotron">
		<div class="container">
				<h2 class="display-4" style="color:#a100ff"><b>Easy</b><span class="display-4" style="color:#ffbb00"><b>GDPR</b></span></h2>
				
				<h3 class="display-9">EXCELSIOR & ACCADEMIA DELLE BELLE ARTI</h3>
		...
		<div class="row" style="text-align:center">
				...
				<!-- <div class="col-md-3">
				<p>
				<img style="width:50%" src="src/persons-icon.png">
				</p>						
						<p><a class="btn btn-secondary" href='?controller=users&action=index' role="button">Interessati »</a></p>
				</div> -->
				<div class="col-md-4">
				<p>
