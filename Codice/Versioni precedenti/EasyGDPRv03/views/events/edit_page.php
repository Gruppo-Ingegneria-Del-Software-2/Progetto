...
<html>
  ...
  <body>
	...
	<h1 style="text-align: center;">Modifica evento numero: <?php echo $event->name;?></h1>
	<form id="new_event" class="container form-signin" method="get" autocomplete="off">
		...
		<div class="form-group">
		<label>Nome</label>
		<input class="form-control " type="text" placeholder="Nome" aria-label="nome" name="name" id="name" required="" value="<?php echo $event->name;?>">
		</div>
		<div class="form-group">
		<label>Dettagli</label>
		<input class="form-control " type="text" placeholder="Dettagli" aria-label="Dettagli" name="details" id="details" required="" value="<?php echo $event->details;?>">
		</div> 
